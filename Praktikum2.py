## Latihan 1
print("===================== Latihan 1 =====================")
myFile = open("F:\Python Project\Basic Scripting\prodi.txt")
content = myFile.read()
myFile.close()
print(content)
print(type(myFile))
...
print("===================== Latihan 4 =====================")
## Latihan 4
buatGw = open("F:\Python Project\Basic Scripting\mfruit.txt")
...
for t in temper:
    print(cel_to_fahr(t))
theFile = open("F:\Python Project\Basic Scripting\pegawai.txt","a+")
theFile.write("\nJhon")
theFile.close()
